...
public class E_Big_Frog_Green: ENE_COMMON
{
	...
	private void Awake()
	{
		...
		pf_slimemini = (GameObject)Resources.Load("SmallSnake");
	...
	private void EneMove()
	{
		...
		if (eneshot_cnt <= 0)
		{
			...
			shotpos.y = 0.0f + UnityEngine.Random.Range(-3.0f, 3.0f);
			GameObject obj_eneshot = (GameObject)Instantiate(pf_slimemini, shotpos, Quaternion.identity);
			obj_eneshot.GetComponent<E_SmallSnake>().set_type(0,dir);
